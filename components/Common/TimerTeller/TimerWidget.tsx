...
const TimerWidget: React.FC = () => {
  ...
  return (
    <footer className="md:w-auto w-[95%] mx-auto md:mx-0 flex md:justify-start justify-between items-center xl:gap-[3rem] md:gap-[1.5rem] gap-2">
      {times.map(({ label, time }, k) => {
        return (
          <div
            ...
            key={k}
          >
            <h4 className="font-Grotesque md:font-normal lg:text-[15px] text-[10px] leading-[20px] text-black text-start uppercase whitespace-nowrap">
              {label}
            </h4>
            <p className="font-Grotesque xxl:w-[58px] lg:w-[50px] w-[30px] font-[200] lg:text-[15px] text-[10px] leading-[20px] text-black text-start">
              {time}
            </p>
          </div>
        );
