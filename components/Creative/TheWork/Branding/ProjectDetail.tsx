...
function Details() {
  ...
  const SetProjectTitle = () => {
    if (Router.query.branding) setTitle(Router.query.branding);
    else Router.push("/creative/work/branding");
  };
  ...
  return (
    ...
    >
      <Navbar />
      <div className="w-full relative overflow-hidden md:h-[calc(100%-95px)] h-[calc(100%-145px)] m-auto md:px-8 px-4 pt-2">
        <Carousel
          ref={SliderRef}
          dynamicHeight={true}
          showThumbs={false}
